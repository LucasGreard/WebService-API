 ...
 */
final class Version20211209125919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE buyer (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, country_id INT NOT NULL, fullname VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, city VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(45) DEFAULT NULL, age VARCHAR(45) DEFAULT NULL, product_buy JSON DEFAULT NULL, INDEX IDX_84905FB319EB6921 (client_id), INDEX IDX_84905FB3F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, fullname VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, country VARCHAR(255) NOT NULL, money VARCHAR(255) NOT NULL, coeff_change DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE buyer ADD CONSTRAINT FK_84905FB3F92F3E70 FOREIGN KEY (country_id) REFERENCES country (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE buyer DROP FOREIGN KEY FK_84905FB3F92F3E70');
